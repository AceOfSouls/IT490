...
import com.ups.wsdl.xoltws.pickup.v1.PickupPortType;
import com.ups.wsdl.xoltws.pickup.v1.PickupService;
...
public class JAXWSPickupClient {
	...
	static{
        try{
        	...
        	props.load(new FileInputStream("C:\\projects\\DODGE\\Release\\ERDOCS\\pickup\\publish\\assets\\Code Samples\\Web Services\\Pickup\\JAXWS2.1\\build.properties"));
    ...
    try {
		...
		pickupDateInfo.setPickupDate("20100630");
		...
		addressLine.add("315 Saddle Bridge Drive");
		...
		List<PickupPieceType> pickupPiece = pickupCreationRequest.getPickupPiece();
		...
		pickupCreationRequest.setSpecialInstruction("Don't Squeeze the Charmin, PLEASE!!!!");
		...
		/** ************UPSSE******************************/
		 ...
		 PickupCreationResponse  PickupResponse = pkPort.processPickupCreation(pickupCreationRequest, upss);
	...
	}catch (com.ups.wsdl.xoltws.pickup.v1.PickupCreationErrorMessage avE) {
