...
<div id="loginbox">
	<h1 style="position:relative;display:block;" align="center">Welcome to R.O.P.</h1>
        
    	<form style="position: relative;" name="signup" action="/signup/signup.php" method="get" onsubmit="return validateForm()">     	
