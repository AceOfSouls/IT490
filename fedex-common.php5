...
function getProperty($var){
	...
	if($var == 'shipaccount') Return '510087780';
	if($var == 'billaccount') Return '510087780';
	if($var == 'dutyaccount') Return 'XXX';
	if($var == 'accounttovalidate') Return 'XXX';
	if($var == 'meter') Return '119097737';
	if($var == 'key') Return 'UgYvVwdDRFHPf5LO';
	if($var == 'password') Return 'NOurG0hnZTY93FkD1WNsqVdXE';
	...
	if($var == 'trackingnumber') Return '122816215025810';
